const Hero = () => {
  return <section className='flex justify-center font-roboto-medium'>
    <div className="mx-auto max-w-7xl py-36 px-8 grid grid-col-2 items-start gap-8 mt-16 md:items-center md:gap-y-16 md:px-16 md:flex flex-col h-screen">
      <article className='flex flex-col border-2 rounded-md py-8 px-8 -rotate-3 '>
        <div className="flex">
