  ...
  return <section className="mx-auto max-w-2xl h-screen mt-28">
    <div className="flex flex-col px-8 md:grid grid-cols-2 gap-12">
      ...
      <div className='flex flex-col w-96'>
        ...
        <p className="tracking-wider leading-6 mt-4  text-sm"> My journey to software development was influence by my previous work experience in a software company where i was involved in design and implementation of functional requirements for Enterprise Resource applications.</p>
      </div>
    </div>
