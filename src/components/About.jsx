  ...
  return <section className=" h-vh py-8 px-8 md:px-16 bg-gray-100  " id="about" >
    ...
    <div className="flex flex-col gap-10 lg:flex-row py-4 px-4">
      ...
      <div className="ml-4 flex flex-col gap-y-10">
        ...
        <p className="">I have rich experience in working with software company. Also I am good at html, css, javascript, react, java and spring framework. I love to talk with you about my unique skills. Feel free to contact me writing an email with your project idea or employment opportunity.</p>
