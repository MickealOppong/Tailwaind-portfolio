...
const About = () => {
  ...
  return <section className=" bg-gray-100 py-8 " id="about" >
    ...
    <div className="flex flex-col  lg:flex-row px-16 mx-16">
      <div className="flex flex-col gap-y-10">
        ...
        <p className="text-gray-500 leading-6 tracking-wider -mt-8">I am married and also a father. i love spending time with my son who is less than 2 years old. I come from Ghana,West of Africa. I speak English and French although English is my official language. I have a decent knowledge of Polish but still learning and i hope in the not distance future i will speak fluently.
        </p>
