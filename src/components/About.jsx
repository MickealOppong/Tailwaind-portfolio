    ...
    <section className="py-16 mx-auto max-w-5xl" id="about" >
      <article className="px-8 md:px-16 lg:px-32">
        <div className="flex flex-col gap-y-4 ">
          ...
          <p >I am married and also a father and  love spending time with my son. I come from Ghana,  West of Africa. I speak English and French although English is my official language. I have a decent knowledge of Polish but still learning and i hope in the not distance future i will speak fluently.
          </p>
