  ...
  return <section className=" bg-gray-100 py-8 " id="about" >
    ...
    <article className="flex lg:flex-row px-8 md:px-16 lg:px-32">
      <div className="flex flex-col gap-y-10">
        ...
        <p className="text-gray-500 leading-6 tracking-wider -mt-8">I love sports, particular Basketball and football and yes i can play both well. I love going to gym although since the birth of my son, i have not been able  to hit the gym.I am looking forward to restart soon this year. </p>
        ...
        <div className="flex flex-col gap-4">
          ...
          <span className="text-sky-500 font-semibold animate-pulse">mikel.oppon@gmail.com</span>
          <span className="text-sky-600 animate-pulse">+48 739-593-752</span>
        </div>
      </div>
    </article>
  </section>
